...
def get_titer_table(sites):
    ...
    for name, site_list in [
        ...
        ("pms_20", [346, 417, 440, 445, 455, 475, 484, 501])
    ]:
        titer.append([
            name,
            bind_BA1.binding_retained(site_list),
            bind_BA2.binding_retained(site_list),
            bind_BA275.binding_retained(site_list),
            bind_BA5.binding_retained(site_list),
            bind_BQ11.binding_retained(site_list),
            bind_D614G.binding_retained(site_list),
            bind_XBB.binding_retained(site_list)
